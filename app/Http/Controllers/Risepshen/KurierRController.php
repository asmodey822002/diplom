...
class KurierController extends Controller
{
    ...
    {
        return view('risepshen.kurier.index');
    }
    public function kuriersRData()
    {
        ...
        ->addColumn('action', function ($zakaz_kuriers) {
            return '<a href="/risepshen/kurier/'.$zakaz_kuriers->id.'/edit" class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-edit"></i> Edit</a> | <span class="btn btn-xs btn-danger" data-id="'.$zakaz_kuriers->id.'"><i class="glyphicon glyphicon-remove"></i> Dellete</span>';
            })
        ->make(true);
    }
    ...
    public function edit($id)
    {
        ...
        return view('risepshen.kurier.edit', compact('zakaz_kuriers', 'kuriers', 'kur_id', 'sosts', 'sost_id'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $zakaz_kuriers->save();
        return redirect('/risepshen/kurier')->with('success', 'Изменения сохранены');
    }
