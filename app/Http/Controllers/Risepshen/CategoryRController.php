...
class CategoryController extends Controller
{
    ...
    {
        return view('risepshen.category.index');
    }
    public function categoryRData()
    {
        return Datatables::of(Category::query())
        ->addColumn('action', function ($category) {
            return '<a href="/risepshen/category/'.$category->id.'/edit" class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-edit"></i> Edit</a> | <span class="btn btn-xs btn-danger" data-id="'.$category->id.'"><i class="glyphicon glyphicon-remove"></i> Dellete</span>';
            })
        ->make(true);
    }
    ...
    public function create()
    {
        ...
        return view('risepshen.category.edit', compact('category'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/risepshen/category')->with('success', 'Category with id '.$category->id.' added!');
    }
